...
class HospitalPostgres @Inject()(db: Database)
  ...
  override def selectById(id: Long): Option[HospitalEntity] = db.withConnection { implicit conn =>
  ...
  override def selectByName(name: String): Option[HospitalEntity] = db.withConnection { implicit conn =>
